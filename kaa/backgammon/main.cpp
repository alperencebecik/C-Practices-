...
int main()
{
    ...
    int clr,temp,temp2,stay=50,turn=0,playFor=0,diced=0,playTurn=0;
    ...
    while(Gamer1.stoneCounfofPlayer>0 && Gamer2.stoneCounfofPlayer>0 )
    {
            ...
            if(diced==1)
            {
                ...
                if(GetAsyncKeyState(VK_LBUTTON) && playTurn==1)
                {
                     ...
                     for(int i=0;i<24;i++)
                    {
                        ...
                        {
                            if( (csy<= (places[i].coordinates[5])) && (csy>=(places[i].coordinates[1]) ) )
                            {
                            ...
                            else if  ((csy>= (places[i].coordinates[5])) && (csy<=(places[i].coordinates[1]) ))
                            {
                                if(places[i].stoneCount>=1 && places[i].color==15 )
                                {
                                   printf("a");
